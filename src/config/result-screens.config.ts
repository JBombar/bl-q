...
export const INSIGHT_CARD_CONFIG = {
  cards: [
    ...
    },
    {
      ...
      label: 'Spoustec',
      icon: 'lightning',
      fallback: 'Kazdodenni stres',
    },
    {
      type: 'tough_period' as const,
      questionKey: 'q05',
      label: 'Narocne obdobi',
      icon: 'calendar',
      fallback: 'Nedavne obdobi',
    },
    {
  ...
  screens: [
    {
      ...
      progress: 35,
      key: 'completer',
      question: 'Patris mezi lidi, kteri vzdy dokonci to, co zacali?',
      testimonial: '"Diky programu jsem se naucila dotahovat veci do konce." - Petra, 34',
    },
    {
      id: 'C2',
      progress: 56,
      key: 'prioritizeSelf',
      question: 'Citis, ze nastal cas zacit dat sebe a svuj klid na prvni misto?',
      testimonial: '"Konecne jsem si uvedomila, ze musim myslet i na sebe." - Jana, 41',
    },
    {
      id: 'C3',
      progress: 78,
      key: 'learnStress',
      question: 'Chces se naucit, jak prirozene zvladat stres?',
      testimonial: '"Metody jsou jednoduche a fungují v beznem zivote." - Marie, 29',
    },
  ],
};
